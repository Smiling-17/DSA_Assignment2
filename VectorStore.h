...
class AVLTree {
    ...
    public:
        ...
        bool containsNode(AVLNode* node, const K& key) const;
        void inorderHelper(AVLNode* node, void (*action)(const T&)) const;

    protected:
        bool insertNode(AVLNode*& node, const K& key, const T& value, bool& taller);
        void leftBalance(AVLNode*& node, bool& taller);
        void rightBalance(AVLNode*& node, bool& taller);
        bool removeNode(AVLNode*& node, const K& key, bool& shorter, bool& success);
};
